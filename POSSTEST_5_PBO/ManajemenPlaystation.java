...
final class PelangganMember extends Pelanggan {
    ...
    // Method overloading
    public void updatePelanggan(String nama, String kontak, int poin) {
...
// Mengubah Karyawan menjadi abstract class
...
class Staff extends Karyawan {
    ...
    public Staff(String nama, String id, int jamLembur) {
        super(nama, id);
    ...
    // Method overloading
    public void updateKaryawan(String nama, int jamLembur) {
        super.updateKaryawan(nama);
...
public class ManajemenPlaystation {
    ...
    public static void tambahStaff() {
        ...
        daftarKaryawan.add(new Staff(nama, id, jamLembur));
